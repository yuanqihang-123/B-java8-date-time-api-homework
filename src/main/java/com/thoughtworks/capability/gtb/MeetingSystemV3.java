...
//      meetingTime = meetingTime.withDayOfYear(newDayOfYear);
        ...
        ZonedDateTime shanghaiTime = ZonedDateTime.of(meetingTime, shanghai);
        ZonedDateTime chicagoTime = shanghaiTime.withZoneSameInstant(chicago);
        LocalDateTime localDateTime = chicagoTime.toLocalDateTime();
        System.out.println("chicago开会时间是："+localDateTime);
    }
}
